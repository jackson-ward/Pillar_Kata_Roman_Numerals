   ...
   ***************************************************************/
   ...
   /*************** Function: assert_detectOverflow_M_Returns_False *******
       Input: none
       Output: none
       Description: Assert that call detectOverflow('M') returns
                    false.
   ***************************************************************/
   void assert_detectOverflow_M_Returns_False()
   {
      ...
      assert(detectOverflow(input) == false);
   }

   /*************** Function: assert_detectOverflow_MMMCM_returns_False *******
       Input: none
       Output: none
       Description: Assert that call detectOverflow("MMMCM") returns False
   ***************************************************************/
   ...
   /*************** Function: assert_detectLargerSubtrahend_I_II_Returns_True *******
       Input: none
       Output: none
